...
<p class="bc"><?php echo <a href="<?php echo home_url();?>">Home</a> &rsaquo; Leadership &amp; History &rsaquo; Child Protection &amp; Safety; ?></p>
<h1><?php echo Child Protection &amp; Safety; ?></h1>
</div></div>
<div class="coming"><div class="coming-inner">
<h2>This Page Is Coming Soon</h2>
<p><?php echo Children's Bible Ministries is deeply committed to the safety and protection of every child in our care.; ?></p>
<div class="note"><p>⚠️ <strong>Webmaster note:</strong> <?php echo Add CBM's full child protection policy, training requirements, background check standards, and reporting procedures. Content needed from client / legal team.; ?></p></div>
