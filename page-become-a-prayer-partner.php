<?php /* Template Name: Become a Prayer Partner */ ?>
<!DOCTYPE html>
<html <?php language_attributes(); ?>>
<head>
<meta charset="<?php bloginfo('charset'); ?>">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Become a Prayer Partner | Children's Bible Ministries</title>
<?php wp_head(); ?>
<style>
...
<p class="bc"><?php echo <a href="<?php echo home_url();?>">Home</a> &rsaquo; Prayer &amp; Engagement &rsaquo; Become a Prayer Partner; ?></p>
<h1><?php echo Become a Prayer Partner; ?></h1>
</div></div>
<div class="coming"><div class="coming-inner">
<h2>This Page Is Coming Soon</h2>
<p><?php echo Prayer is foundational to CBM's ministry. Become a prayer partner and stand with missionaries and ministry workers in intercession.; ?></p>
<div class="note"><p>⚠️ <strong>Webmaster note:</strong> <?php echo No content found in PDF. Awaiting content from client. Should include a prayer partner signup form.; ?></p></div>
