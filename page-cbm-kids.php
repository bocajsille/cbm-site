<?php /* Template Name: CBM Kids */ ?>
<!DOCTYPE html>
<html <?php language_attributes(); ?>>
<head>
<meta charset="<?php bloginfo('charset'); ?>">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>CBM Kids | Children's Bible Ministries</title>
<?php wp_head(); ?>
<style>
...
<p class="bc"><?php echo <a href="<?php echo home_url();?>">Home</a> &rsaquo; Family &amp; Children Resources &rsaquo; CBM Kids; ?></p>
<h1><?php echo CBM Kids; ?></h1>
</div></div>
<div class="coming"><div class="coming-inner">
<h2>This Page Is Coming Soon</h2>
<p><?php echo CBM Kids offers Bible-centered resources and content for children and families.; ?></p>
