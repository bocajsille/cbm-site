...
<p class="bc"><?php echo <a href="<?php echo home_url();?>">Home</a> &rsaquo; Give &rsaquo; Ways to Give; ?></p>
<h1><?php echo Ways to Give; ?></h1>
</div></div>
<div class="coming"><div class="coming-inner">
<h2>This Page Is Coming Soon</h2>
<p><?php echo Support the mission of Children's Bible Ministries through online giving, check, stock, estate planning, and more.; ?></p>
<div class="note"><p>⚠️ <strong>Webmaster note:</strong> <?php echo No content found in PDF. Should explain all giving methods: online (continuetogive.com/cbm), check by mail, stock gifts, estate/planned giving, vehicle donations, etc. Awaiting content from client.; ?></p></div>
