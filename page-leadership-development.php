<?php /* Template Name: Leadership Development */ ?>
<!DOCTYPE html>
<html <?php language_attributes(); ?>>
<head>
<meta charset="<?php bloginfo('charset'); ?>">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Leadership Development | Children's Bible Ministries</title>
<?php wp_head(); ?>
<style>
...
<p class="bc"><?php echo <a href="<?php echo home_url();?>">Home</a> &rsaquo; Training &amp; Calling &rsaquo; Leadership Development; ?></p>
<h1><?php echo Leadership Development; ?></h1>
</div></div>
<div class="coming"><div class="coming-inner">
<h2>This Page Is Coming Soon</h2>
<p><?php echo CBM invests in developing future ministry leaders through training, mentorship, and practical experience.; ?></p>
