...
<title>Strategic Funds | Children's Bible Ministries</title>
<?php wp_head(); ?>
<style>
...
<p class="bc"><?php echo <a href="<?php echo home_url();?>">Home</a> &rsaquo; Give &rsaquo; Strategic Funds; ?></p>
<h1><?php echo Strategic Funds; ?></h1>
</div></div>
<div class="coming"><div class="coming-inner">
<h2>This Page Is Coming Soon</h2>
<p><?php echo Strategic Funds allow donors to direct gifts toward key areas of CBM ministry that sustain and expand Gospel work.; ?></p>
<div class="note"><p>⚠️ <strong>Webmaster note:</strong> <?php echo Should list and link to: Global Impact Fund, Expansion Fund, Pastor &amp; Missionary Rest &amp; Renewal Fund, Capital Campaign, Special Projects. Awaiting content and fund pages from client.; ?></p></div>
