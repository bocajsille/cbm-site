<?php /* Template Name: Ministry Training Resources */ ?>
<!DOCTYPE html>
<html <?php language_attributes(); ?>>
<head>
<meta charset="<?php bloginfo('charset'); ?>">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Ministry Training Resources | Children's Bible Ministries</title>
<?php wp_head(); ?>
<style>
...
<p class="bc"><?php echo <a href="<?php echo home_url();?>">Home</a> &rsaquo; Church &amp; Leader Resources &rsaquo; Ministry Training Resources; ?></p>
<h1><?php echo Ministry Training Resources; ?></h1>
</div></div>
<div class="coming"><div class="coming-inner">
<h2>This Page Is Coming Soon</h2>
<p><?php echo Training resources for ministry leaders, volunteers, and church workers serving with CBM.; ?></p>
